...
public class DBOperations {
	public String Processname;
	  ...
	  public String getValues(String sQuery, String tablecol) { String result = "";
	    ...
	    try
	    {
	      ...
	      if (conn != null) {
	        ...
	        String array[]=tablecol.split(",");
	                    	       
	        while (rs.next())
	        {
	        	helpStr = null;
	        	for(String str : array){
	        		String rsData=rs.getString(str);
	        		 this.logObj.servicelog("rsData="+rsData);
	        		/*if(str.contains("date")) {
	        			rsData=getDateFormat(str,"dd/MM/yyyy","dd/MM/yyyy");
	        		}*/
	        		if(rsData == null)
	        		{
	        			rsData="";
	  ...
	  public String postValues(String sQuery) { String result = "";
